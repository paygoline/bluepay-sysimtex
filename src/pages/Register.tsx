...
const Register = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Show celebration for all registrations
    toast({
      title: "🎉✨ Registration Successful! 🎊🥳",
      description: referralCode 
        ? `💫 Welcome! Your ₦20,000 referral bonus will be credited after PIN setup. ⭐`
        : `🎉 Welcome to BluePay! Your account has been created successfully. ✨`,
    });
